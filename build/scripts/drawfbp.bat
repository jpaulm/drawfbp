...
@rem Add default JVM options here. You can also use JAVA_OPTS and DRAWFBP_OPTS to pass JVM options to this script.
...
set CLASSPATH=%APP_HOME%\lib\drawfbp-2.20.13.jar;%APP_HOME%\lib\javaGeom-0.11.1.jar;%APP_HOME%\lib\javahelp-2.0.05.jar
