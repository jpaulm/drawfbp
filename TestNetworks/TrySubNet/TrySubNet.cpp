...
int elem0 = 0;
/*
This test case loads InfQueue dynamically from the TestNetworks.dll, and then runs it under the "Copy" process
*/
...
proc_ent P2 = {&P1, "Copy", "InfQueue", NULL, NULL, NULL,  !TRACE, COMPOS};
