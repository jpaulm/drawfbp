...
A pre-Release version - v2.18.2 - is available in Releases, with a much speeded up sort function.  The jar file is `drawfbp-all-2.18.2.jar` - it will be promoted after further testing.
