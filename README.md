...
Releases from v2.18.2 have a much speeded up sort function (by name or by date, optionally).  The next version - `drawfbp-2.18.4.jar` - is now available for evaluation.
