...
Two experimental pre-releases, v2.15.0 and v2.15.1, were posted to Github, to see if unnecessary repaints are causing excessive CPU usage, but have since been deleted.  **This issue has now been solved with v2.15.2.**
