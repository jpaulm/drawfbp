...
Latest release is v2.16.16: the jar file, which includes the `math.geom2d` jar file, can be obtained from the Releases folder.   The latest release *on Maven* is v2.16.14:
