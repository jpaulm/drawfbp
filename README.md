...
Latest release is `v3.0.1`: the jar file (which includes the `math.geom2d` and `JavaHelp` jar files) - `drawfbp-3.0.1.jar` - can be obtained from the Releases folder (click on `tags`, then `Releases`), `build/libs`, and Maven, shortly.  
