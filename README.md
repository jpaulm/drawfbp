...
Current release is `v3.1.7`.  The major Zoom issue, #79, has been fixed, and the jar file will appear on Maven shortly.  A more specific issue, #80, also to do with Zoom, has been raised.
