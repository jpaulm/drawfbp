...
Latest release is v2.18.5: the jar file (which includes the `math.geom2d` jar file) - `drawfbp-2.18.5.jar` - can be obtained from the Releases folder, or from `build/libs`.  All these copies are identical.
