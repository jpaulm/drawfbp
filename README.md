...
Latest release is `v2.20.1`: the jar file (which includes the `math.geom2d` and `JavaHelp` jar files) - `drawfbp-2.20.1.jar` - can be obtained from the Releases folder, or from `build/libs`... and shortly from Maven.  
