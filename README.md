...
A pre-Release version - v2.18.3 - is available in Releases, with a much speeded up sort function (by name or by date, optionally).  The jar file - `drawfbp-2.18.3.jar` - will be promoted after further testing.
