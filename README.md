...
Latest release is `v2.22.5`: the jar file (which includes the `math.geom2d` and `JavaHelp` jar files) - `drawfbp-2.22.5.jar` - can be obtained from the Releases folder (click on `tags`, then `Releases`), `build/libs`, and Maven, shortly.  
