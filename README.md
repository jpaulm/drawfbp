...
#### Latest release is 2.15.6.  This jar file is now available and can be obtained by looking in Releases.  This release will shortly be made available on Maven - download the .jar file from Releases (or Maven shortly), and execute using Java Platform SE binary.  
