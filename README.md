...
#### There is a problem in the File Selection function of v2.13.23 - the last good version is v2.13.22.  You can find it in Releases.   Download the .jar file from here, and execute using Java Platform SE binary.  
